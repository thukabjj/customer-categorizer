...
public class CustomerMapperImplTest {
    ...
    @DisplayName("Test - Should mapper Customer Domain to Customer Entrypoint Response")
    @Test
    public void should_mapper_customer_domain_to_customer_entrypoint_response() {
        ...
        //then
        final List<CustomerEntrypointResponse> response = customerMapper.fromCustomerDomainToCustomerEntrypointResponse(customers);
